...
echo "Ipotizzo fine esecuzione del test fra $PGBENCH_TIME secondi:"
end_time=$(( PGBENCH_TIME * PGBENCH_RUNS ))
echo $(date -v"+${end_time}S")
...
do
    ...
    $PGBENCH_CMD  -T $PGBENCH_TIME -j 5 -c 20  $PGBENCH_DB >> $current_log 2>&1
