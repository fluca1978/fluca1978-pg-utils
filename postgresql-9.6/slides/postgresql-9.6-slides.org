...
...
-rw-------  1 postgres  postgres    16M Oct 30 13:01 000000010000000100000091
-rw-------  1 postgres  postgres    16M Oct 30 13:01 000000010000000100000092
-rw-------  1 postgres  postgres   1.5K Oct 30 13:01 log.txt
#+end_src
...
archive_timeout = 10
#+end_src
e i log sono archiviati ogni 10 secondi:
#+begin_src sh
% sudo -u postgres cat /mnt/data2/wal_archive/log.txt
OK Mon, 30 Oct 2017 13:15:08 +0100: WAL segment 000000010000000100000094 copiato
OK Mon, 30 Oct 2017 13:15:18 +0100: WAL segment 000000010000000100000095 copiato
OK Mon, 30 Oct 2017 13:15:29 +0100: WAL segment 000000010000000100000096 copiato
#+end_src
*** PITR Manuale
...
2. effettuare il backup dei file di dati;
