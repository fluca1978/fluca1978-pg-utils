...
:END:
*** La vista ~pg_shadow~
In analogia con i sistemi Unix, è disponibuile una vista ~pg_shadow~ che riassume i dati degli account utente (ruoli) comprensivi di password. Se la password inizia con ~md5~ la password è stata cifrata con tale algoritmo. Ovviamente occorre essere superutente per poter interrogare la vista.
#+begin_src sql
...
# WITH files AS ( SELECT pg_ls_dir( 'pg_log' ) )
  SELECT * FROM files
  WHERE pg_ls_dir like '%-2017-11-13%';
            pg_ls_dir
----------------------------------
 postgresql-2017-11-13_093647.log
 postgresql-2017-11-13_113553.log
 postgresql-2017-11-13_134555.log
 postgresql-2017-11-13_144325.log
#+end_src

*** Esempio di lettura di un file
#+begin_src sql
# SELECT regexp_split_to_table(
            pg_read_file( 'pg_log/postgresql-2017-11-13_093647.log' ),
                          E'\\n' );

 LOG:  database system was shut down at 2017-11-10 13:26:30 CET
 DEBUG:  checkpoint record is at 4/429836E8
 DEBUG:  redo record is at 4/429836E8; shutdown TRUE
 DEBUG:  next transaction ID: 0:3001; next OID: 19748
...
Database system identifier:           6476345954120890666
Database cluster state:               in production
pg_control last modified:             Wed Nov 15 10:11:18 2017
Latest checkpoint location:           4/42AA9A38
Prior checkpoint location:            4/42AA9360
Latest checkpoint's REDO location:    4/42AA9A38
Latest checkpoint's REDO WAL file:    000000010000000400000042
Latest checkpoint's TimeLineID:       1
...
Time of latest checkpoint:            Wed Nov 15 10:11:17 2017
...
